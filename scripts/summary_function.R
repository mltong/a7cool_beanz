...
#taking info 498f. It will return a list with information about the original data_frame.
write_summary <- function(data) {
  ...
  return(list(num_freshman = num_freshman, num_sophomore = num_sophomore, 
